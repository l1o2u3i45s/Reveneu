...
namespace Reveneu
{
    public partial class Pres_Goal : Form
    {
        string connStr = "";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SQL += "tg_num = '" + textBox1.Text + "' ";
            SQL += "WHERE tg_date = '" + str_date + "' and ";
            SQL += "tg_store = '" + comboBox1.Text.Substring(0, 7) + "'";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            string SQLcmd = "select * from target where tg_date = '" + str_date + "'";
            ...
            if (i > 1)
                dataGridView1.CurrentCell = dataGridView1.Rows[i].Cells["Column1"]; // 游標位置
        ...
        private void Pres_Goal_Load(object sender, EventArgs e)
        {
        ...
        private void Pres_Goal_Click(object sender, EventArgs e)
        {
            dataGridView1.Visible = false;
        }
